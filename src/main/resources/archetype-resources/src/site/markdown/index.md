...
This is a base project created with the [Library Maven Archetype][spring-web-service-maven-archetype], prepared to ease the development of new libraries.
...
First of all, check the [Library Maven Archetype][spring-web-service-maven-archetype] documentation, and then edit the readme file and the Maven site descriptions about the project.
...
[spring-web-service-maven-archetype]: https://github.com/Bernardo-MG/spring-web-service-maven-archetype